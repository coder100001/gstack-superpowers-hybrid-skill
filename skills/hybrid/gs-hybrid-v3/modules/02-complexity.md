...
**要求**:
- **完全跳过三层架构**，无需 DISCOVERY/REQUIREMENT_LOCK/ARCH_REVIEW
- 无需状态栏显示（可选简化为 `[状态: L0 极简模式]`）
- 仅需测试验证（如有测试）
- 无需产出任何文档
...
| 状态 | 名称 | L0 | L1 | L2 | L3 | 说明 |
|:-----:|------|:--:|:--:|:--:|:--:|------|
| Step 0 | 复杂度评估 | ✅ | ✅ | ✅ | ✅ | 所有任务必须 |
| DISCOVERY | 需求澄清 | ⏭️ | ⚪ | 🔴 | 🔴 | L0 跳过，L1 可选，L2+ 必须 |
| REQUIREMENT_LOCK | 需求确认 | ⏭️ | 🔴(合并) | 🔴 | 🔴 | L0 跳过，L1 与 DISCOVERY 合并确认 |
| ARCH_REVIEW | 架构审议 | ⏭️ | ⚪ | 🟡 | 🔴 | L0/L1 跳过，L2→2维度，L3→5维度 |
| TASK_DECOMPOSITION | 任务拆解 | ⏭️ | ✅ | ✅ | ✅ | L0 跳过，L1+ 必须 |
| PLAN_CONFIRM | Plan 确认 | ⏭️ | 🔴(合并) | 🔴 | 🔴 | L0 跳过，L1 与 TASK_DECOMPOSITION 合并确认 |
| Context Hydration | 上下文注水 | ⏭️ | ⚪ | 🟡 | 🔴 | L0 跳过，L1 简化，L2+ 必须 |
| IMPLEMENTATION | 编码实现 | ✅ | ✅ | ✅ | ✅ | 所有级别必须 |
| SELF_REVIEW | 自审 | ⏭️ | ⚪ | 🟡 | 🔴 | L0/L1 跳过，L2+ 必须 |
| QA | 质量验证 | ⏭️ | ⚪ | ⚪ | 🔴 | L0/L1/L2 跳过，仅 L3 强制 |
| SHIP_REVIEW | 发布检查 | ⚪ | ✅ | ✅ | ✅ | L0 可选，L1+ 必须 |
| RETRO | 复盘记录 | ⏭️ | ⚪ | ⚪ | 🔴 | L0/L1/L2 跳过，仅 L3 强制 |

> 图例：✅ 必须 | 🟡 L2+ 必须 | 🔴 必须 | ⚪ 可选 | 🔴(合并) L1 合并确认 | ⏭️ 跳过
